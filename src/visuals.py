...
class VisualTetris:
    ...
    def render(self):
        ...
        img = np.zeros((self.height * self.block_size, self.width * self.block_size, 3), dtype=np.uint8)
        ...
        # Overlay score
        cv2.putText(img, f"Score: {self.score}", (10, self.block_size * self.height + 20),
